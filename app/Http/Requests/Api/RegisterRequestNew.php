...
class RegisterRequestNew extends FormRequest
{
    ...
    {   
        $rules =  [
            ...
            'lat'               => ['required','string','min:1','max:1000'],
            'lng'               => ['required','string','min:1','max:1000'],       
            'fcm_token'         => ['required'],
            'profile_image'     => ['required'] //,'mimes:jpeg,png,jpg,gif,svg','max:10240'
        ...
        if(request()->has('user_type')) {
           ...
           if($user_type == 'business') {
                $rules = array_merge($rules,[
                   ...
                   'restaurant_closing_time' => ['required','string', 'date_format:H:i'],
